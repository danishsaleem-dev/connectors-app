    ...
    switch (field.kind) {
      ...
      case ProfileFieldKind.multiline:
        return TextField(
          ...
          keyboardType:
              field.kind == ProfileFieldKind.number ? TextInputType.number : TextInputType.text,
      ...
      case ProfileFieldKind.multiSelect:
        final selected = (ProfileDraft.get(field.key) as List?)?.cast<String>() ?? const <String>[];
        return Wrap(
          spacing: 8,
          runSpacing: 8,
            ...
            return InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: isOn ? AppColors.violet600 : AppColors.grey200),
                  borderRadius: BorderRadius.circular(999),
                ),
                child: Text(
                  option,
      ...
      case ProfileFieldKind.upload:
        ...
        return InkWell(
          ...
          onTap: () {
            setState(() => ProfileDraft.set(field.key, done ? null : 'attached'));
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: done ? AppColors.violet600.withValues(alpha: 0.06) : AppColors.grey50,
              border: Border.all(color: done ? AppColors.violet600 : AppColors.grey200),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Column(
              children: [
